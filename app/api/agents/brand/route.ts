  ...
  return createDataStreamResponse({
    execute: async (dataStream) => {
      ...
      const result = streamText({
        ...
        // toolChoice: 'required',
        // tools: {
        //   createBrandFoundation: {
        //     description: 'Create a brand foundation',
        //     parameters: z.object({
        //       brandOptions: z
        //         .array(
        //           z.object({
        ...
        //             description: z
        //               .string()
        //               .describe('A brief description of the brand concept'),
        //             tagline: z
        //               .string()
        //               .optional()
        //               .describe('A catchy tagline for the brand'),
        ...
        //       context: z
        //         .string()
        //         .describe('Brief context about what inspired these options'),
        //     }),
        //   },
        // },
      })
